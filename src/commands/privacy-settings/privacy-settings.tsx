...
const FALLBACK_MESSAGE = 'Review and manage your privacy settings at https://spark-ai.top/settings/data-privacy-controls';
export async function call(onDone: LocalJSXCommandOnDone): Promise<React.ReactNode | null> {
  ...
  async function onDoneWithSettingsCheck() {
    ...
    const groveStatus = updatedSettings.grove_enabled ? '已开启' : '已关闭';
    onDone(`“帮助改进 Claude”已${groveStatus}。`);
