...
export function InstallAppStep(t0) {
  ...
  let t6;
  if ($[5] !== repoUrl) {
    t6 = <Box marginBottom={1}><Text>请为此仓库安装应用：<Text bold={true}>{repoUrl}</Text></Text></Box>;
    $[5] = repoUrl;
    $[6] = t6;
  } else {
    t6 = $[6];
  ...
  if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
    t7 = <Box marginBottom={1}><Text dimColor={true}>重要：请确认已授权访问此特定仓库</Text></Box>;
    $[7] = t7;
  } else {
    t7 = $[7];
  }
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Box><Text bold={true} color="permission">安装完成后按 Enter{figures.ellipsis}</Text></Box>;
    $[8] = t8;
  } else {
    t8 = $[8];
  }
  ...
  if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = <Box marginTop={1}><Text dimColor={true}>遇到问题？查看手动设置说明：{" "}<Text color="claude">{GITHUB_ACTION_SETUP_DOCS_URL}</Text></Text></Box>;
    $[9] = t9;
  } else {
    t9 = $[9];
  }
