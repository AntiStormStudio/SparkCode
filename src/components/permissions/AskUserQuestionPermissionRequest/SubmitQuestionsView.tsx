...
export function SubmitQuestionsView(t0) {
  ...
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = <PermissionRequestTitle title="检查你的答案" color="text" />;
    $[5] = t3;
  } else {
    t3 = $[5];
  }
  ...
  if ($[6] !== allQuestionsAnswered) {
    t4 = !allQuestionsAnswered && <Box marginBottom={1}><Text color="warning">{figures.warning} 还有问题没有回答</Text></Box>;
  ...
  if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
    t7 = <Text color="inactive">准备提交你的答案了吗？</Text>;
    $[13] = t7;
  } else {
    t7 = $[13];
  }
