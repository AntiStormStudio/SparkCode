...
export function buildPlanApprovalOptions({
  ...
  if (showUltraplan) {
    options.push({
      label: '否，在网页版 Spark Code 用 Ultraplan 继续完善',
      value: 'ultraplan'
    });
  }
  options.push({
    ...
    label: '否，继续规划',
    value: 'no',
    placeholder: '告诉 Claude 要改什么',
    description: 'shift+tab 使用这条反馈批准',
