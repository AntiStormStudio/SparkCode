...
export function GlobalSearchDialog(t0) {
  ...
  let t12;
  if ($[18] !== isSearching) {
    t12 = q_0 => isSearching ? "Searching\u2026" : q_0 ? "No matches" : "输入搜索\u2026";
    $[18] = isSearching;
    $[19] = t12;
  } else {
    t12 = $[19];
  ...
  if ($[28] !== handleOpen || $[29] !== matchLabel || $[30] !== matches || $[31] !== onDone || $[32] !== t10 || $[33] !== t11 || $[34] !== t12 || $[35] !== t13 || $[36] !== t14 || $[37] !== t9 || $[38] !== visibleResults) {
    t15 = <FuzzyPicker title="全局搜索" placeholder={"输入搜索\u2026"} items={matches} getKey={matchKey} visibleCount={visibleResults} direction="up" previewPosition={t9} onQueryChange={handleQueryChange} onFocus={setFocused} onSelect={handleOpen} onTab={t10} onShiftTab={t11} onCancel={onDone} emptyMessage={t12} matchLabel={matchLabel} selectAction="在编辑器中打开" renderItem={t13} renderPreview={t14} />;
    $[28] = handleOpen;
    $[29] = matchLabel;
    $[30] = matches;
    $[31] = onDone;
