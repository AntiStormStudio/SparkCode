...
export function IdeOnboardingDialog(t0) {
  ...
  let t6;
  if ($[8] !== ideName) {
    t6 = <>{t5}<Text>Welcome to Spark Code for {ideName}</Text></>;
    $[8] = ideName;
    $[9] = t6;
  } else {
    t6 = $[9];
  ...
  if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
    t11 = <Text>• Review Spark Code's changes{" "}{t10}{" "}<Text color="diffRemovedWord">-22</Text> in the comfort of your IDE</Text>;
    $[13] = t11;
  } else {
    t11 = $[13];
  }
  ...
  if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
    t15 = <Box paddingX={1}><Text dimColor={true} italic={true}>Press Enter 继续</Text></Box>;
    $[20] = t15;
  } else {
    t15 = $[20];
  }
