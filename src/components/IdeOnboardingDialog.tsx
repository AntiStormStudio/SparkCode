...
export function IdeOnboardingDialog(t0) {
  ...
  let t6;
  if ($[8] !== ideName) {
    t6 = <>{t5}<Text>欢迎使用 {ideName} 版 Spark Code</Text></>;
    $[8] = ideName;
    $[9] = t6;
  } else {
    t6 = $[9];
  ...
  if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Text color="suggestion">⧉ 已打开的文件</Text>;
    $[10] = t8;
  } else {
    t8 = $[10];
  }
  ...
  if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = <Text>• Spark 会读取 {t8}{" "}和 <Text color="suggestion">⧉ 已选中的代码行</Text> 作为上下文</Text>;
    $[11] = t9;
  } else {
    t9 = $[11];
  }
  ...
  if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
    t11 = <Text>• 在 IDE 里查看 Spark Code 的改动{" "}{t10}{" "}<Text color="diffRemovedWord">-22</Text></Text>;
    $[13] = t11;
  } else {
    t11 = $[13];
  }
