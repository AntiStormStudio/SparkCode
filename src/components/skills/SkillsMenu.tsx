...
export function SkillsMenu(t0) {
  ...
  if (skills.length === 0) {
    ...
    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
      t3 = <Text dimColor={true}>在 .claude/skills/ 或 ~/.claude/skills/ 中创建 skills</Text>;
      $[6] = t3;
    } else {
      t3 = $[6];
    }
    ...
    let t5;
    if ($[8] !== handleCancel) {
      t5 = <Dialog title="技能" subtitle="没有找到技能" onCancel={handleCancel} hideInputGuide={true}>{t3}{t4}</Dialog>;
      $[8] = handleCancel;
      $[9] = t5;
    } else {
      t5 = $[9];
