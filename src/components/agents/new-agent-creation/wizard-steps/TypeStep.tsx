...
export function TypeStep(_props) {
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = <Byline><KeyboardShortcutHint shortcut="输入" action="编辑文本" /><KeyboardShortcutHint shortcut="Enter" action="继续" /><ConfigurableShortcutHint action="confirm:no" context="Settings" fallback="Esc" description="返回" /></Byline>;
    $[4] = t2;
  } else {
    t2 = $[4];
  }
