...
export function GenerateStep(): ReactNode {
  ...
  const subtitle = '请描述这个 Agent 要做什么、在什么场景使用（描述越完整，效果越好）';
  if (isGenerating) {
  ...
  return <WizardDialogLayout subtitle={subtitle} footerText={<Byline>
      ...
      <Box flexDirection="column">
        ...
        <TextInput value={prompt} onChange={setPrompt} onSubmit={handleGenerate} placeholder="例如：帮我为当前代码编写单元测试..." columns={80} cursorOffset={cursorOffset} onChangeCursorOffset={setCursorOffset} focus showCursor />
      </Box>
    </WizardDialogLayout>;
}
