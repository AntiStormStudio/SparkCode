...
export function ToolsStep(t0) {
  ...
  if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = <Byline><KeyboardShortcutHint shortcut="Enter" action="切换选择" /><KeyboardShortcutHint shortcut={"\u2191\u2193"} action="移动" /><ConfigurableShortcutHint action="confirm:no" context="Confirmation" fallback="Esc" description="返回" /></Byline>;
    $[3] = t2;
  } else {
    t2 = $[3];
  }
