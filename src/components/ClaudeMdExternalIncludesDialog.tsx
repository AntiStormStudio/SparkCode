...
export function ClaudeMdExternalIncludesDialog(t0) {
  ...
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Text>此项目的 SPARK.md 导入了当前工作目录外的文件。对第三方仓库不要允许这种行为。</Text>;
    $[5] = t6;
  } else {
    t6 = $[5];
  }
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Text dimColor={true}>重要：只对你信任的文件使用 Spark Code。访问不受信任的文件可能带来安全风险{" "}<Link url="https://code.claude.com/docs/en/security" />{" "}</Text>;
    $[8] = t8;
  } else {
    t8 = $[8];
  }
  ...
  if ($[12] !== handleEscape || $[13] !== t10 || $[14] !== t4 || $[15] !== t5 || $[16] !== t7) {
    t11 = <Dialog title="允许外部 SPARK.md 文件导入？" color="warning" onCancel={handleEscape} hideBorder={t4} hideInputGuide={t5}>{t6}{t7}{t8}{t10}</Dialog>;
    $[12] = handleEscape;
    $[13] = t10;
    $[14] = t4;
    $[15] = t5;
