...
export function BackgroundTasksDialog({
  ...
  if (viewState.mode !== 'list' && typedTasks) {
    ...
    switch (task_0.type) {
      ...
      case 'dream':
        return <DreamDetailDialog task={task_0} onDone={() => onDone('已关闭后台任务对话框', {
          display: 'system'
