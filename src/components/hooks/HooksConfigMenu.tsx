...
export function HooksConfigMenu(t0) {
  ...
  if (hooksDisabled_1) {
    ...
    if ($[35] === Symbol.for("react.memo_cache_sentinel")) {
      t21 = <Text bold={true}>停用</Text>;
      $[35] = t21;
    } else {
      t21 = $[35];
    }
    const t22 = disabledByPolicy && "（由托管设置文件控制）";
    let t23;
    ...
    if ($[42] !== t22 || $[43] !== t23 || $[44] !== t24 || $[45] !== t25) {
      t26 = <Text>所有 Hooks 当前已{t21}{t22}。你有 {t23} 个已配置的 Hook 未运行。</Text>;
      $[42] = t22;
      $[43] = t23;
      $[44] = t24;
      $[45] = t25;
    ...
    if ($[47] === Symbol.for("react.memo_cache_sentinel")) {
      t27 = <Box marginTop={1}><Text dimColor={true}>Hooks 停用后：</Text></Box>;
      t28 = <Text dimColor={true}>· 不会执行任何 Hook 命令</Text>;
      t29 = <Text dimColor={true}>· 不会显示 StatusLine</Text>;
      t30 = <Text dimColor={true}>· 工具操作会跳过 Hook 验证继续执行</Text>;
      $[47] = t27;
      $[48] = t28;
      $[49] = t29;
      $[50] = t30;
    ...
    if ($[53] !== disabledByPolicy) {
      t32 = !disabledByPolicy && <Text dimColor={true}>要重新启用 Hooks，请从 settings.json 中移除 "disableAllHooks"，或让 Claude 协助。</Text>;
      $[53] = disabledByPolicy;
      $[54] = t32;
    } else {
      t32 = $[54];
    ...
    if ($[58] !== handleExit || $[59] !== t33) {
      t34 = <Dialog title="Hook 配置 - 已停用" onCancel={handleExit} inputGuide={_temp6}>{t33}</Dialog>;
      $[58] = handleExit;
      $[59] = t33;
      $[60] = t34;
    } else {
