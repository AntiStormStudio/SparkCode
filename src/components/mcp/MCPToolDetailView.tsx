...
function _temp(exitState) {
  return exitState.pending ? <Text>再次按 {exitState.keyName} 退出</Text> : <ConfigurableShortcutHint action="confirm:no" context="Confirmation" fallback="Esc" description="go back" />;
}
