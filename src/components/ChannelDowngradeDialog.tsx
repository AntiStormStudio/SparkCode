...
export function ChannelDowngradeDialog(t0) {
  ...
  let t3;
  if ($[4] !== currentVersion) {
    t3 = <Text>稳定频道的版本可能比你当前运行的版本更旧（{currentVersion}）。</Text>;
    $[4] = currentVersion;
    $[5] = t3;
  } else {
    t3 = $[5];
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Text dimColor={true}>你想怎么处理？</Text>;
    $[6] = t4;
  } else {
    t4 = $[6];
  }
  ...
  const t6 = `保留当前版本（${currentVersion}），直到稳定频道追上`;
  let t7;
  if ($[8] !== t6) {
    t7 = [t5, {
      label: t6,
  ...
  if ($[13] !== handleCancel || $[14] !== t3 || $[15] !== t8) {
    t9 = <Dialog title="切换到稳定频道" onCancel={handleCancel} color="permission" hideBorder={true} hideInputGuide={true}>{t3}{t4}{t8}</Dialog>;
    $[13] = handleCancel;
    $[14] = t3;
    $[15] = t8;
    $[16] = t9;
