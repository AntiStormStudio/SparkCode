...
export type GlobalConfig = {
  ...
  mcpServers?: Record<string, McpServerConfig>
  // spark-ai.top MCP connectors that have successfully connected at least once.
  ...
  firstStartTime?: string // ISO timestamp when Spark Code was first started on this machine
  ...
  // Spark Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Spark Code OAuth token
  ...
  // Spark Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
