...
const APP_NAME = 'Spark Code URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Spark Code URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Spark Code Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Spark Code
