...
// Always ask when Spark Code tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Spark Code for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Spark Code)
