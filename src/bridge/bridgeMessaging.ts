...
export type ServerControlRequestHandlers = {
   ...
   * Used by the outbound-only bridge mode and the SDK's /bridge subpath so spark-ai.top sees a
...
export function handleServerControlRequest(
  ...
  // Outbound-only: reply error for mutable requests so spark-ai.top doesn't show
