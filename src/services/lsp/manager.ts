 ...
 * Initialized during Spark Code startup.
 */
 ...
 * asynchronously during Spark Code startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during Spark Code startup. It synchronously creates
 ...
 *
 * This should be called during Spark Code shutdown. Stops all running LSP servers
