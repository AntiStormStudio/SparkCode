...
// spark-ai.top server names are prefixed with this string
const CLAUDEAI_SERVER_PREFIX = 'spark-ai.top '

/**
 * Normalize server names to be compatible with the API pattern ^[a-zA-Z0-9_-]{1,64}$
 * Replaces any invalid characters (including dots and spaces) with underscores.
 *
 * For spark-ai.top servers (names starting with "spark-ai.top "), also collapses
