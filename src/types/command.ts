 ...
 * spark-ai.top subscribers and direct Console API key users (api.anthropic.com),
 * but hides it from Bedrock/Vertex/Foundry users and custom base URL users.
 */
export type CommandAvailability =
  // spark-ai.top OAuth subscriber (Pro/Max/Team/Enterprise via spark-ai.top)
  | 'claude-ai'
  // Console API key user (direct api.anthropic.com, not via spark-ai.top OAuth)
  | 'console'
